        ...
        <div class="navbar-text ms-3">
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="profileDropdown">
                    <a class="dropdown-item" href="{{ route('company.updateaccount', auth('company')->user()->id) }}" style="color: #333;">Account</a>
...
<nav class="navbar-sidebar">
    <div class="profile-image-container">
        <img src="{{ asset(Auth::guard('company')->user()->logo) }}" alt="Profile" class="rounded-circle custom-circle" height="80">
    </div>
    <ul class="navbar-nav flex-column">
        <li class="nav-item">
            <a class="nav-link" href="{{ route('company.dashboard') }}" style="color: #fff;">
                <i class="bi bi-speedometer2 dashboard-icon"></i> Dashboard
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="{{ route('company.postjob') }}" style="color: #fff;">
                <i class="bi bi-file-post post-job-icon"></i> Post a Job
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="{{ route('company.joblist') }}" style="color: #fff;">
                <i class="bi bi-activity activity-icon"></i> Activity
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="{{ route('company.messages') }}" style="color: #fff;">
                <i class="bi bi-envelope messages-icon"></i> Messages
            </a>

        </li>
        <li class="nav-item">
            <a class="nav-link" href="{{ route('company.candidatelist') }}" style="color: #fff;">
                <i class="bi bi-envelope candidates-icon"></i> Candidate
            </a>
        </li>
    </ul>
    ...
    <ul class="navbar-nav flex-column mt-auto">
        <li class="nav-item">
            <a class="nav-link" href="{{ route('company-help-center') }}" style="color: #fff;">
                <i class="bi bi-headset help-center-icon"></i> Help Center
            </a>
        </li>
    </ul>
</nav>
